...
const translations = {
  ...
  es: {
    ...
    "adminAdvancedSearchDesc": "Utiliza los filtros para encontrar rápidamente tickets por estado, prioridad, categoría o usuario.",
    "adminAssignmentPrioritization": "Asignación y Priorización",
    "adminAssignmentPrioritizationDesc": "Asigna tickets a técnicos, establece prioridades y gestiona su ciclo de vida completo.",
    "adminKeyActions": "Acciones Principales",
    "adminAssignment": "Asignación",
    "adminAssignmentDesc": "Puedes asignarte tickets o reasignarlos a otros técnicos según sea necesario.",
